                    ...
                    <table class="table table-centered table-striped dt-responsive nowrap w-100" id="products-datatable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="table-user">
                                    <a href="javascript:void(0);" class="text-body font-weight-semibold">Kebun Highland</a>
                                </td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="field-3" class="control-label">Nama Kebun</label>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="field-3" class="control-label">Petani</label>
                                <select name="" id="" class="form-control" >
                                    <option value="">Seppy</option>
                                    <option value="">Jho</option>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="field-3" class="control-label">Titik Kordinat</label>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <img src="assets/images/products/" alt="" srcset="">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Tamba Kebun</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                </div>
                <div class="modal-body p-4">
